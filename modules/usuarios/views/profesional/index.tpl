			...
			<table class="table table-bordered table-hover">
				 <thead>
					<tr>
						...
						<th style="width: 10%">Rol o Función</th>
				 ...
				 <tbody >
					<tr>
						...
						<td style="width: 20px; text-align: center;">
							<a href="{$_layoutParams.root}usuarios/profesional/editar/{$us.id}" style="height: 30px; margin-left: 30px"><i class="fa fa-edit"></i></a>
						</td>
						<td style="width: 20px; text-align: center;">
							<a href="{$_layoutParams.root}usuarios/index/permisos/{$us.id}" style="height: 30px; margin-left: 30px"><i class="fa fa-lock"></i></a>
						</td>
						<td style="width: 20px; text-align: center;">
							<a href="{$_layoutParams.root}usuarios/profesional/eliminar/{$us.id}" style="height: 30px; margin-left: 30px"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>
				 </tbody>
				{/foreach}
